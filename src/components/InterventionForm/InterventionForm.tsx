                ...
                <Container>
                    <FormContainer onSubmit={(e: React.FormEvent) => handleSubmit(e)}>
                        <TextField
                            ...
                            onChange={(e) => onInterventionChange(InterventionData.NAME, e.target.value)}
                        ></TextField>
                        <TextField
                            className="formInput"
                            id="standard-basic"
                            ...
                            onChange={(e) => onInterventionChange(InterventionData.LOCATION, e.target.value)}
                        ></TextField>
                        <TextField
                            className="formInput"
                            id="standard-basic"
                            ...
                            onChange={(e) => onInterventionChange(InterventionData.LEADER, e.target.value)}
                        ></TextField>
